...
namespace Trecom.Api.Services.Catalog.Migrations
{
    ...
    [Migration("20230731181656_deneme2")]
            ...
            modelBuilder.Entity("Trecom.Api.Services.Catalog.Models.Entities.BaseCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3c5983c0-2959-400b-9d37-087e1ecdde5f"),
                            CreatedDate = new DateTime(2023, 7, 31, 21, 16, 56, 625, DateTimeKind.Local).AddTicks(827),
                            IsActive = true,
                            Name = "Base Deneme"
                        });
                });
            ...
            modelBuilder.Entity("Trecom.Api.Services.Catalog.Models.Entities.TypeCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3f0af26e-1828-4f89-b800-18ae76d393f9"),
                            BaseCategoryId = new Guid("3c5983c0-2959-400b-9d37-087e1ecdde5f"),
                            CreatedDate = new DateTime(2023, 7, 31, 21, 16, 56, 625, DateTimeKind.Local).AddTicks(838),
                            IsActive = true,
                            Name = "Type Deneme"
                        });
                });
